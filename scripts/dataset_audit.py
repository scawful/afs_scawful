...
DATASET_TARGETS = {
    ...
    "monolith_v1.jsonl":            {"target": 40,  "desc": "Monolith brutalist code synthesis"},
    "conductor_v1.jsonl":           {"target": 40,  "desc": "Conductor swarm DAG orchestration"},
    "conductor_v3.jsonl":           {"target": 120, "desc": "Conductor v3 DAG + JSON repair dataset"},
    "steward_v1.jsonl":             {"target": 40,  "desc": "Steward task management operator"},
    "journalist_v1.jsonl":          {"target": 40,  "desc": "Journalist reflection and journaling"},
    "poet_v1.jsonl":                {"target": 40,  "desc": "Poet creative writing and verse"},
    "essayist_v1.jsonl":            {"target": 40,  "desc": "Essayist long-form argument drafting"},
    "poet_v2.jsonl":                {"target": 40,  "desc": "Poet v2 live-teacher dataset"},
    "poet_v3.jsonl":                {"target": 40,  "desc": "Poet v3 compact-form dataset"},
    "poet_v4.jsonl":                {"target": 40,  "desc": "Poet v4 form-controlled dataset"},
    "essayist_v2.jsonl":            {"target": 40,  "desc": "Essayist v2 live-teacher dataset"},
    "essays_gdrive_raw_v1.jsonl":   {"target": 80,  "desc": "Raw essay text imported from Google Drive"},
    "commit_diff_v1.jsonl":         {"target": 2000, "desc": "Commit msg ↔ diff pairs (free)"},
    "weaver_v1.jsonl":              {"target": 50,  "desc": "Weaver cross-project"},
    "weaver_distill_v1.jsonl":      {"target": 10,  "desc": "Weaver distillation"},
